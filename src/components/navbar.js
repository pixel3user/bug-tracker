...
export default function NavBar() {                          // i really never have to change this shitty navbar so , lets just save time here. bye
  ...
  return (
    <header className='h-12 bg-gray-50 dark:bg-black dark:border-gray-400 dark:border-b-[1px] fixed w-full top-0 shadow-lg'>
                ...
                <ul className={`${menuItems} w-full space-y-2 pr-3 font-semibold text-xl text-right md:h-12 md:flex md:flex-row md:items-center md:justify-end md:space-x-5 md:space-y-0 dark:text-white`}>
                    <div className='w-1/2 flex flex-row'>
                        <div className='w-full'>
                            <input onClick={searchState} onChange={e => setsearchValue(e.target.value)} placeholder='Search...' className='w-full hidden lg:block bg-gray-50 px-1.5 py-1 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'  />
